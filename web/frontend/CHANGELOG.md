...
### Added
- `dot-pattern` utility class in `globals.css` for subtle white dot grid overlay effect
- CSS override for `wp-block-cover` to apply dot pattern to background overlay instead of wrapper
