...
/**
 * Title: Home
 * Slug: wonderjarcreative-backend/home
 * Categories: page
 * Description: Home page pattern with cover, services, and contact form.
 *
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="http://localhost:3000/about/">Work With Our Team</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p>We build fast, scalable websites tailored to your brand and performance goals. Every project is optimized for speed, accessibility, and long-term growth. From architecture to design, we create digital experiences that look sharp, load fast, and adapt as your business evolves.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:image {"id":313,"width":"400px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="http://wonderjarcreative.local/wp-content/uploads/2025/07/coding-a-website.png" alt="Lady pointing at website" class="wp-image-313" style="width:400px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:paragraph -->
<p>Our cloud solutions deliver security, performance, and peace of mind. We manage everything from migrations and uptime monitoring to backups and scaling, so your site stays reliable and responsive. Whether you’re launching new or optimizing an existing platform, we keep your digital foundation strong.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:paragraph -->
<p>We lead purpose-driven projects that demand strategy, speed, and impact. From advocacy campaigns to focused brand launches, we combine web design, SEO, and advertising to reach the right audience with the right message. Each project is built to make an impression — and measurable results.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:image {"id":429,"width":"400px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="http://wonderjarcreative.local/wp-content/uploads/2025/10/Group.png" alt="Group on the way up" class="wp-image-429" style="width:400px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<!-- wp:details {"fontSize":"3xl"} -->
<details class="wp-block-details has-3-xl-font-size"><summary><strong>Tailored, Agile Collaboration</strong></summary><!-- wp:paragraph {"fontSize":"xl"} -->
<p class="has-xl-font-size">Every project starts from the ground up. We assemble the right mix of development, cloud, and campaign expertise to match your goals — no templates, no one-size-fits-all builds.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->

<!-- wp:details {"fontSize":"3xl"} -->
<details class="wp-block-details has-3-xl-font-size"><summary><strong>Remote-First, Denver-Rooted</strong></summary><!-- wp:paragraph {"fontSize":"xl"} -->
<p class="has-xl-font-size">We collaborate seamlessly from anywhere and show up locally when it counts. Whether virtual or in-person, you’ll always feel connected and supported from kickoff to launch.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->

<!-- wp:details {"fontSize":"3xl"} -->
<details class="wp-block-details has-3-xl-font-size"><summary><strong>Focused on Measurable Impact</strong></summary><!-- wp:paragraph {"fontSize":"xl"} -->
<p class="has-xl-font-size">Our work is driven by performance, data, and long-term results. We measure, refine, and grow alongside you — turning every launch into a foundation for sustainable success.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":442,"width":"400px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="http://wonderjarcreative.local/wp-content/uploads/2025/10/about-our-team.png" alt="About Our Team Image" class="wp-image-442" style="width:400px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
