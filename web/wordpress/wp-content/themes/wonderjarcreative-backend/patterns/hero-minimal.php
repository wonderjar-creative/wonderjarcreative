...
<div class="wp-block-group alignwide"><!-- wp:heading {"textAlign":"center","level":1,"align":"wide","className":"text-4xl md:text-6xl lg:text-8xl","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|40"}}}} -->
<h1 class="wp-block-heading alignwide has-text-align-center text-4xl md:text-6xl lg:text-8xl" style="margin-bottom:var(--wp--preset--spacing--40)">Hero Title</h1>
<!-- /wp:heading -->
